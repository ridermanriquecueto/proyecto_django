...
def lista_materias(request):
    ...
    materias_habilitadas = usuarios_materia.objects.filter(ciclo_lectivo = '2022')

    # Obtener las materias en las que aún hay cupo
    #materias_habilitadas = [materia for materia in inscripciones_estudiante.filter(.nota_cursada)]

    return render(request, 'registration/lista_materias.html', {'materias': materias_habilitadas})
